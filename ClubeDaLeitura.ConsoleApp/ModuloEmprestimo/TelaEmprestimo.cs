...
public class TelaEmprestimo //Não será uma tela base
{
    ...
    public void VisualizarTodos(bool deveExibirCabecalho)
    {
        ...
        Console.WriteLine("{0, -7} | {1, -15} | {2, -15} | {3, -13} | {4, -13}",
        ...
        for (int i = 0; i < emprestimos.Length; i++)
        {
            ...
            Console.WriteLine("{0, -7} | {1, -15} | {2, -15} | {3, -13} | {4, -13}",
                            e.Id, e.Revista.Titulo, e.Amigo.Nome, e.DataAbertura.ToShortDateString(), e.DataConclusaoPrevista.ToShortDateString());
        }
